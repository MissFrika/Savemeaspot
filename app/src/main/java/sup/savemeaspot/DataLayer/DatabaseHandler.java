...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    db.execSQL("CREATE TABLE " +TABLE_NAME_CAT+
            " (" +COLUMN_ID_CAT+ " INTEGER PRIMARY KEY, " +COLUMN_NAME_CAT+ " TEXT, " +COLUMN_ICON_CAT+" TEXT," +COLUMN_DELETABLE+ " BOOLEAN)");

    //Coordinate table
    db.execSQL("CREATE TABLE " +TABLE_NAME_COR+
            " (" +COLUMN_ID_COR+ " INTEGER PRIMARY KEY, " +COLUMN_LAT+ " DOUBLE, " +COLUMN_LON+" DOUBLE," +COLUMN_ADDRESS+ " TEXT ," +COLUMN_COUNTRY+ " TEXT)");

    //Spot table
    db.execSQL("CREATE TABLE " +TABLE_NAME_SPOT+
            " (" +COLUMN_ID_SPOT+ " INTEGER PRIMARY KEY, " +COLUMN_TITLE+ " TEXT, " +COLUMN_DESCRIPTION+" TEXT, " +COLUMN_CATEGORY+ " INTEGER, " +COLUMN_COORDINATE+
            " INTEGER, FOREIGN KEY(" +COLUMN_CATEGORY+ ") REFERENCES Category(categoryid), FOREIGN KEY ("+ COLUMN_COORDINATE + ") REFERENCES Coordinate(coordinateid))");
